 ...
 *     Approximate a time series using a continuous piecewise linear function.
 */
  __pyx_t_1 = __Pyx_CyFunction_New(&__pyx_mdef_5fABBA_20chainApproximation_c_1compress, 0, __pyx_n_s_compress, NULL, __pyx_n_s_fABBA_chainApproximation_c, __pyx_d, ((PyObject *)__pyx_codeobj__22)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
