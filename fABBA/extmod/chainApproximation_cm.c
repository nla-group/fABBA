 ...
 */
    ...
    __pyx_t_10 = -1;
    if (__pyx_t_9 < 0) {
      __pyx_t_9 += __pyx_v_ts.shape[0];
      if (unlikely(__pyx_t_9 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_9 >= __pyx_v_ts.shape[0])) __pyx_t_10 = 0;
...
__pyx_t_9 = __pyx_v_i;
      __pyx_t_14 = -1;
      if (__pyx_t_9 < 0) {
        __pyx_t_9 += __pyx_t_7.shape[0];
        if (unlikely(__pyx_t_9 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_9 >= __pyx_t_7.shape[0])) __pyx_t_14 = 0;
...
__pyx_t_16 = __pyx_v_i;
      __pyx_t_14 = -1;
      if (__pyx_t_16 < 0) {
        __pyx_t_16 += __pyx_t_15.shape[0];
        if (unlikely(__pyx_t_16 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_16 >= __pyx_t_15.shape[0])) __pyx_t_14 = 0;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 75, __pyx_L1_error)
      }
 ...
 *     Approximate a time series using a continuous piecewise linear function.
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5fABBA_6extmod_21chainApproximation_cm_1compress, NULL, __pyx_n_s_fABBA_extmod_chainApproximation_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
