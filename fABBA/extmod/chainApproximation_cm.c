...
static const char __pyx_k_License_BSD_3_clause_Copyright[] = "\nLicense: BSD 3 clause\n\nCopyright (c) 2021, Stefan G\303\274ttel, Xinye Chen\nAll rights reserved.\n";
...
/* "fABBA/extmod/chainApproximation_cm.pyx":17
 * # @cython.binding(True)
 * 
...
static PyObject *__pyx_pw_5fABBA_6extmod_21chainApproximation_cm_1compress(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("compress (wrapper)", 0);
  {
    ...
    __pyx_v_ts = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ts.memview)) __PYX_ERR(0, 17, __pyx_L3_error)
    if (values[1]) {
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "fABBA/extmod/chainApproximation_cm.pyx":33
 * 
 *     if max_len < 0:
 *         max_len = len(ts)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fABBA/extmod/chainApproximation_cm.pyx":35
 *         max_len = len(ts)
 * 
 *     cdef int start = 0             # <<<<<<<<<<<<<<
 *     cdef int end = 1
 ...
 */
  ...
  /* "fABBA/extmod/chainApproximation_cm.pyx":36
 * 
 *     cdef int start = 0
 *     cdef int end = 1             # <<<<<<<<<<<<<<
 *     cdef int i, len_t = len(ts)
 ...
 */
  ...
  /* "fABBA/extmod/chainApproximation_cm.pyx":37
 *     cdef int start = 0
 *     cdef int end = 1
 *     cdef int i, len_t = len(ts)             # <<<<<<<<<<<<<<
 *     cdef list pieces = list() # np.empty([0, 3])
 ...
 */
  ...
  /* "fABBA/extmod/chainApproximation_cm.pyx":38
 *     cdef int end = 1
 *     cdef int i, len_t = len(ts)
 *     cdef list pieces = list() # np.empty([0, 3])             # <<<<<<<<<<<<<<
 *     cdef double[:] x = np.arange(0, len_t, dtype=float)
 ...
 */
  ...
  /* "fABBA/extmod/chainApproximation_cm.pyx":39
 *     cdef int i, len_t = len(ts)
 *     cdef list pieces = list() # np.empty([0, 3])
 *     cdef double[:] x = np.arange(0, len_t, dtype=float)             # <<<<<<<<<<<<<<
 *     cdef double epsilon =  np.finfo(float).eps
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_arange); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_len_t); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_5, __pyx_t_3); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_6, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 39, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_finfo); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = NULL;
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_eps); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  ...
  /* "fABBA/extmod/chainApproximation_cm.pyx":45
 ...
 */
  while (1) {
    ...
    /* "fABBA/extmod/chainApproximation_cm.pyx":46
 * 
 *     while end < len_t:
 *         t_st = ts[start]             # <<<<<<<<<<<<<<
 *         t_ed = ts[end]
 ...
 */
    ...
    /* "fABBA/extmod/chainApproximation_cm.pyx":47
 *     while end < len_t:
 *         t_st = ts[start]
 *         t_ed = ts[end]             # <<<<<<<<<<<<<<
 *         inc = t_ed - t_st
 ...
 */
    ...
    /* "fABBA/extmod/chainApproximation_cm.pyx":48
 *         t_st = ts[start]
 *         t_ed = ts[end]
 *         inc = t_ed - t_st             # <<<<<<<<<<<<<<
 *         err = 0.0
 ...
 */
    ...
    /* "fABBA/extmod/chainApproximation_cm.pyx":49
 *         t_ed = ts[end]
 *         inc = t_ed - t_st
 *         err = 0.0             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "fABBA/extmod/chainApproximation_cm.pyx":51
 *         err = 0.0
 * 
 *         for i in range(end-start+1):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_12; __pyx_t_10+=1) {
      ...
      /* "fABBA/extmod/chainApproximation_cm.pyx":52
 * 
 *         for i in range(end-start+1):
 *             err = err + (t_st + (inc/(end-start))*x[0:end-start+1][i] - ts[start:end+1][i])**2             # <<<<<<<<<<<<<<
 * 
...
__pyx_t_16 = __pyx_v_i;
    ...
    /* "fABBA/extmod/chainApproximation_cm.pyx":54
 *             err = err + (t_st + (inc/(end-start))*x[0:end-start+1][i] - ts[start:end+1][i])**2
 * 
 *         if (err <= tol*(end-start-1) + epsilon) and (end-start-1 < max_len):             # <<<<<<<<<<<<<<
 ...
 */
    /*else*/ {
      __pyx_t_5 = __Pyx_PyInt_From_long(((__pyx_v_end - __pyx_v_start) - 1)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 59, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_6 = PyFloat_FromDouble(__pyx_v_lastinc); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 59, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_3 = PyFloat_FromDouble(__pyx_v_lasterr); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 59, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      ...
      __pyx_t_6 = 0;
      __pyx_t_3 = 0;
      __pyx_t_19 = __Pyx_PyList_Append(__pyx_v_pieces, __pyx_t_4); if (unlikely(__pyx_t_19 == ((int)-1))) __PYX_ERR(0, 59, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 *     return pieces
 */
  __pyx_t_4 = __Pyx_PyInt_From_long(((__pyx_v_end - __pyx_v_start) - 1)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 63, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_3 = PyFloat_FromDouble(__pyx_v_lastinc); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 63, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __pyx_t_3 = 0;
  __pyx_t_6 = 0;
  __pyx_t_19 = __Pyx_PyList_Append(__pyx_v_pieces, __pyx_t_5); if (unlikely(__pyx_t_19 == ((int)-1))) __PYX_ERR(0, 63, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

  /* "fABBA/extmod/chainApproximation_cm.pyx":65
 *     pieces.append([end-start-1, lastinc, lasterr])
 * 
 *     return pieces             # <<<<<<<<<<<<<<
 */
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    __pyx_k_License_BSD_3_clause_Copyright, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("chainApproximation_cm", __pyx_methods, __pyx_k_License_BSD_3_clause_Copyright, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  /* "fABBA/extmod/chainApproximation_cm.pyx":9
 * 
 * cimport cython
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "fABBA/extmod/chainApproximation_cm.pyx":11
 * import numpy as np
 * cimport numpy as np
 * np.import_array()             # <<<<<<<<<<<<<<
 * 
 ...
 *     Approximate a time series using a continuous piecewise linear function.
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5fABBA_6extmod_21chainApproximation_cm_1compress, NULL, __pyx_n_s_fABBA_extmod_chainApproximation_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
